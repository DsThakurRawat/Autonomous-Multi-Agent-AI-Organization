...
) if PROMETHEUS_AVAILABLE else _NoOpMetric()
...
project_duration_seconds = _metric(
    Histogram,
...
budget_utilization_pct = _metric(
    Gauge,
...
project_cost_usd_total = _metric(
    Counter,
...
moe_routing_latency_ms = _metric(
    Histogram,
