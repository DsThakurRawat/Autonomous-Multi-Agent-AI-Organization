...
class SkillsRegistryTool(BaseTool):
    ...
    DESCRIPTION = "Dynamically downloads and installs external agent tools/skills at runtime."
    TIMEOUT_S = 180
    ...
    async def _execute_skill(self, skill_name: str, **kwargs) -> ToolResult:
        ...
        if skill_name in sys.modules:
            ...
            try:
                ...
                return ToolResult(False, "", error=f"Skill {skill_name} not installed. {e}")
        ...
        try:
            ...
            return ToolResult(False, "", error=f"Execution of scalar skill {skill_name} failed: {e}")
